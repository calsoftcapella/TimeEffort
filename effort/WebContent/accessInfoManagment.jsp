		...
		<div id="container">
			<html:form action="displayReport" method="post">
				<table align="left"
					...
					<tr>
						<td><b>Select User:</b> <logic:notEmpty name="list" scope="request">
								<html:select property="userId" styleId="userId"
									onchange="submitReport1('reportmanagement.do?method=getAllocationListForResource');"
					...
					<tr>
						<td>
							<table style="width: 240px;">
								<tr>
									...
									<td width="10%" style="padding-left: 10px;"><logic:notEmpty name="combinedList"
											scope="request">
											<input type="button" value=">>"
												onclick="submitReport1('reportmanagement.do?method=addResourcesAccess');">
										</logic:notEmpty> <logic:notEmpty name="combinedList" scope="request">
											<input type="button"
												onclick="submitReport1('reportmanagement.do?method=deleteResourcesAccess')"
												value="<<">
										</logic:notEmpty></td>
								</tr>
							</table>
						...
						<td>
							<table>
								<tr>								
									<td style="padding-left: 40px;"><logic:notPresent name="displaySelectBox"
											scope="request">
					...
					<tr>
						...
						<logic:notEmpty name="combinedList" scope="request">
							<!-- <td>
<input type="button"  value="Get User Access Mapping" onclick="submitReport1('reportmanagement.do?method=getUserAccessMappingDetailedList');" style="width: 170px;font-family: verdana, arial, sans-serif;font-size: 11px;">
</td> -->
							<td><input type="button" value="Get All User Access Mapping"
								onclick="submitReport1('reportmanagement.do?method=getAllUserAccessMappingDetails');"
	...
	<display:table   id="data" name="requestScope.updatedallocatedList" requestURI="reportmanagement.do?method=getUserAccessMappingDetailedList" export="true" decorator="com.calsoft.report.decorator.UserReportAccessMappingDecorator" class="hovertable" >	
	      <display:column property="parentUserName" title="User"  />
          <display:column  property="userName" title="Access To" />
          <display:setProperty name="export.excel.filename" value="userAccessMapping.xlsx"/>
          <display:setProperty name="export.pdf.filename" value="userAccessMapping.pdf"/>
